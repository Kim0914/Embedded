...
int main() {
	//LCD ﹉u﹞A 卹昆A５A足 LCD_Init ０╳ ▽╱Co伊C取i AOA╱易C﹞I ０使▽a卹〝 CO CE０a 取帚A卦
	SystemInit();
	RCC_Configure();
	GPIO_Configure();
	ADC_Configure();
	...
	while(1){
                ...
                LCD_DrawCircle(x, y, 5); // AIA╳CN AU╱Ｙ０╳ 伊０▽▼Ｄo易I ▽▼╱Ｙ▽a
                LCD_ShowNum(60, 300, light, 10, color[11], color[0]); // AＤ伊伊 ﹉見 Aa﹞A               
	}
}