...
void EXTI_Configure(void)
{
    ...
    /* Button S1: PD11*/
   	PIO_EXTILineConfig(GPIO_PortSourceGPIOD, GPIO_PinSource11);
...
void NVIC_Configure(void) {
    ...
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_IPR0_PRI_4;
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = NVIC_IPR0_PRI_0;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_IPR0_PRI_3;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = NVIC_IPR0_PRI_0;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_IPR0_PRI_2;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = NVIC_IPR0_PRI_0;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_IPR0_PRI_1;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
}
